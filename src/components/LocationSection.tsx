...
const LocationSection = () => {
  ...
  return (
    <section id="localizacao" className="px-4 sm:px-6 md:px-14 py-12 sm:py-16 md:py-24">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-[100px] max-w-[1400px] mx-auto">
        ...
        <div>
          ...
          <div className="mt-8 sm:mt-10 md:mt-14">
            {distances.map((d, i) => (
              <ScrollReveal key={i} delay={0.2 + i * 0.08}>
                <div className="flex items-center justify-between gap-3 py-4 sm:py-5 border-b gold-border-line group transition-all duration-300 hover:pl-1 flex-wrap sm:flex-nowrap">
                  <div className="flex-1">
                    <span
                      className="font-body text-[12px] sm:text-[14px] block"
                    ...
                    <span
                      ...
                      style={{ letterSpacing: "0.25em", color: "rgba(200,160,80,0.5)", fontFamily: "'Tenor Sans', sans-serif", textTransform: "uppercase" }}
                    >
                      {language === "pt" ? d.notePt : d.noteEn}
                    </span>
                  </div>
                  <span
                    className="font-display text-gold text-[22px] sm:text-[28px] shrink-0"
          ...
          <ScrollReveal delay={0.6}>
            <div className="mt-8 sm:mt-10 pt-6 sm:pt-8 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4" style={{ borderTop: "1px solid hsl(var(--gold) / 0.15)" }}>
              <div className="min-w-0">
                <p
                  className="font-display break-all"
                  style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(16px, 3.5vw, 20px)", color: "rgba(30,22,14,0.50)", letterSpacing: "0.08em" }}
                >
                  38°10'N · 8°34'W
                </p>
                <p style={{ fontSize: "clamp(8px, 2vw, 9px)", letterSpacing: "0.3em", color: "rgba(200,160,80,0.45)", fontFamily: "'Tenor Sans', sans-serif", textTransform: "uppercase", marginTop: "4px" }}>
                  {language === "pt" ? "Grândola, Alentejo" : "Grândola, Alentejo"}
                </p>
              </div>
              <Link
                to="/localizacao"
                className="flex items-center gap-2 transition-all duration-300 group shrink-0"
                style={{ textDecoration: "none" }}
              >
                <span className="label-upper text-[7px] sm:text-[9px]" style={{ color: "hsl(var(--gold))" }}>
                  {language === "pt" ? "Ver Mapa" : "View Map"}
                </span>
                <ArrowRight size={12} style={{ color: "hsl(var(--gold))" }} className="transition-transform duration-300 group-hover:translate-x-1" />
              </Link>
            </div>
          </ScrollReveal>
        </div>
        ...
        <ScrollReveal delay={0.2}>
          <div className="relative w-full" style={{ aspectRatio: "1/1" }}>
            ...
            <div
              className="absolute bottom-4 left-4 right-4 sm:bottom-5 sm:left-5 md:right-auto md:left-5 z-10"
              style={{
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p
                    style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(14px, 3vw, 17px)", color: "hsl(var(--foreground))", lineHeight: 1.3 }}
                  >
                    Herdade em <em>Grândola</em>
                  </p>
                  <p style={{ fontFamily: "'Tenor Sans', sans-serif", fontSize: "clamp(10px, 2vw, 11px)", color: "rgba(30,22,14,0.45)", marginTop: "4px" }}>
                    Santa Margarida da Serra
                  </p>
                  <p style={{ fontFamily: "'Tenor Sans', sans-serif", fontSize: "clamp(10px, 2vw, 11px)", color: "rgba(30,22,14,0.45)" }}>
                    Alentejo · Portugal
                  </p>
                  <div style={{ borderTop: "1px solid hsl(var(--gold) / 0.12)", marginTop: "10px", paddingTop: "8px" }}>
                    <a
                      ...
                      className="flex items-center gap-1.5 transition-all duration-300 group text-[7px] sm:text-[9px]"
                      style={{ textDecoration: "none" }}
                    >
                      <span style={{ fontFamily: "'Tenor Sans', sans-serif", letterSpacing: "0.2em", textTransform: "uppercase", color: "hsl(var(--gold))" }}>
                        {language === "pt" ? "Abrir no Maps" : "Open in Maps"}
                      </span>
                      <ArrowRight size={8} style={{ color: "hsl(var(--gold))" }} className="transition-transform duration-300 group-hover:translate-x-0.5" />
                    </a>
                  </div>
                </div>
              </div>

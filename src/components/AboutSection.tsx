...
const AboutSection = () => {
  ...
  const renderHeading = () => {
    if (language === "pt") {
      return <>A oportunidade que o mercado <em>já não oferece</em></>;
    }
    return <>The opportunity the market <em>no longer offers</em></>;
  };

  return (
    <section id="propriedade" className="px-4 sm:px-6 md:px-14 py-12 sm:py-16 md:py-24">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-[100px] items-start max-w-[1400px] mx-auto">
        <div>
          <ScrollReveal>
          ...
          <ScrollReveal delay={0.2}>
            <blockquote className="border-l border-gold/40 pl-4 sm:pl-6 mt-8 sm:mt-10 font-display italic text-base sm:text-lg md:text-[24px] leading-relaxed" style={{ color: "rgba(30,22,14,0.65)" }}>
          ...
          <ScrollReveal delay={0.6}>
            <p className="body-text mt-6">{language === "pt" ? about.p4 : about.p4En}</p>
          </ScrollReveal>
        </div>
